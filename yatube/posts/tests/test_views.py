...
class PostViewTests(TestCase):
    ...
    def post_correct(self, page_context):
    ...
    def test_index_show_correct_context(self):
        ...
        self.post_correct(page_index_context)

    def test_post_detail_show_correct_context(self):
        """Шаблон post_detail сформирован с правильным контекстом."""
        response_post_detail = self.authorized_client.get(
            reverse(
                'posts:post_detail', kwargs={'post_id': PostViewTests.post.pk}
            )
        )
        page_post_detail_context = response_post_detail.context
        self.post_correct(page_post_detail_context)
    ...
    def test_group_page_show_correct_context(self):
        ...
        self.post_correct(page_group_context)
    ...
    def test_profile_show_correct_context(self):
        ...
        self.post_correct(page_profile_context)
    ...
    def test_following_posts(self):
        ...
        self.post_correct(context_follow)
